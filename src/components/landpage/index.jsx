  ...
  return (
    <section className="mx-auto max-w-screen-2xl px-4 md:px-8">
      <div className="mb-8 flex flex-wrap justify-between md:mb-16">
        <div className="mb-6 mt-10 mb:mt-0 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pb-24 lg:pt-48">
          ...
          <p className="max-w-md leading-relaxed text-gray-500 xl:text-lg">
            Discover a curated collection of trendy and timeless fashion pieces,
            tailored to elevate your wardrobe and express your unique style.
          </p>
        </div>
      ...
      <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
        <div className="flex h-12 w-64 divide-x overflow-hidden rounded-lg border">
          <Link
            ...
            className="flex w-1/3 items-center justify-center text-sm md:text-base text-gray-500 transition duration-100 hover:bg-gray-100 active:bg-gray-200"
          >
            Men
          </Link>
          <Link
